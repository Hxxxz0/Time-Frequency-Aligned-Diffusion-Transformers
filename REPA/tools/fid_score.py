...
def compute_statistics_of_path(path, model, batch_size, dims, device, num_workers=8, max_images=None):
...
def save_statistics_of_path(path, out_path, device=None, batch_size=50, dims=2048, num_workers=8, max_images=None):
    if device is None:
    ...
    m1, s1 = compute_statistics_of_path(path, model, batch_size, dims, device, num_workers, max_images)
...
def calculate_fid_given_paths(paths, device=None, batch_size=50, dims=2048, num_workers=8):
    ...
    m1, s1 = compute_statistics_of_path(paths[0], model, batch_size,
                                        dims, device, num_workers, max_images=None)
